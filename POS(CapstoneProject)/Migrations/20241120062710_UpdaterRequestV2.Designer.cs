...
namespace POS_CapstoneProject_.Migrations
{
    ...
    [Migration("20241120062710_UpdaterRequestV2")]
    partial class UpdaterRequestV2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POS_CapstoneProject_.Models.Receipt", b =>
                {
            ...
            modelBuilder.Entity("POS_CapstoneProject_.Models.Receipt", b =>
                {
                    b.HasOne("POS_CapstoneProject_.Models.Order", "Orders")
                        .WithMany()
                        .HasForeignKey("OrderID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("POS_CapstoneProject_.Models.User", "Users")
                        .WithMany()
                        .HasForeignKey("UserID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
