...
namespace POS_CapstoneProject_.Controllers
{
    public class InventoryTransactionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InventoryTransactId,UserId,TransactionDate,TransactionType,RequestId,Remarks")] InventoryTransaction inventoryTransaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InventoryTransactId,UserId,TransactionDate,TransactionType,RequestId,Remarks")] InventoryTransaction inventoryTransaction)
        {
