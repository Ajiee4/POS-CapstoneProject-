...
namespace POS_CapstoneProject_.Controllers
{
    public class InventoryTransactionsController : Controller
    {
        ...
        {
            var pOS_CapstoneProject_Context = _context.InventoryTransaction.Include(i => i.User);
        ...
        public async Task<IActionResult> Create([Bind("InventoryTransactId,UserId,TransactionDate,TransactionType")] InventoryTransaction inventoryTransaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InventoryTransactId,UserId,TransactionDate,TransactionType")] InventoryTransaction inventoryTransaction)
        {
