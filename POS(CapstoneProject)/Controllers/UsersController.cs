...
namespace POS_CapstoneProject_.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(POS_CapstoneProject_Context context)
        {
            _context = context;
        }
        ...
        {
            var pOS_CapstoneProject_Context = _context.User.Include(u => u.Role);
        ...
        public async Task<IActionResult> Create([Bind("UserId,Username,Password,RoleId,isArchive")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Username,Password,RoleId,isArchive")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
