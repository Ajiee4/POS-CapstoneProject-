...
namespace POS_CapstoneProject_.Controllers
{
    public class InventoryTransactionDetailsController : Controller
    {
        ...
        {
            ViewData["IngredientId"] = new SelectList(_context.Ingredient, "IngredientId", "Brand");
            ViewData["InventoryTransactId"] = new SelectList(_context.InventoryTransaction, "InvenotryTransactId", "TransactionType");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("InventoryTransactDetailId,InventoryTransactId,IngredientId,Quantity,Remarks")] InventoryTransactionDetail inventoryTransactionDetail)
        {
            ...
            ViewData["IngredientId"] = new SelectList(_context.Ingredient, "IngredientId", "Brand", inventoryTransactionDetail.IngredientId);
            ViewData["InventoryTransactId"] = new SelectList(_context.InventoryTransaction, "InvenotryTransactId", "TransactionType", inventoryTransactionDetail.InventoryTransactId);
            return View(inventoryTransactionDetail);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InventoryTransactDetailId,InventoryTransactId,IngredientId,Quantity,Remarks")] InventoryTransactionDetail inventoryTransactionDetail)
        {
