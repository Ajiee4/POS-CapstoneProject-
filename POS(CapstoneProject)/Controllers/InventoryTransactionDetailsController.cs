...
namespace POS_CapstoneProject_.Controllers
{
    public class InventoryTransactionDetailsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["InventoryTransactId"] = new SelectList(_context.InventoryTransaction, "InventoryTransactId", "Remarks");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("InventoryTransactDetailId,InventoryTransactId,IngredientId,Quantity,UpdatedQty,QtyOnHand")] InventoryTransactionDetail inventoryTransactionDetail)
        {
            ...
            ViewData["InventoryTransactId"] = new SelectList(_context.InventoryTransaction, "InventoryTransactId", "Remarks", inventoryTransactionDetail.InventoryTransactId);
            return View(inventoryTransactionDetail);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InventoryTransactDetailId,InventoryTransactId,IngredientId,Quantity,UpdatedQty,QtyOnHand")] InventoryTransactionDetail inventoryTransactionDetail)
        {
